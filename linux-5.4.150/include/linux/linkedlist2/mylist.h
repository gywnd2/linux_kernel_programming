 ...
 * @head:	the head for your list.
 */
#define list_for_each_safe(pos1, pos2, n1, n2, head) \
	for (pos1 = (head)->next, pos2 = (head)->prev, n1 = pos1->next, n2 = pos2->prev; pos1 != (head) && pos2 != (head); \
		pos1 = n1, pos2 = n2, n1 = pos1->next, n2 = pos2->prev)
